...
### 18. Batch Configuration System (In Progress)
- ✅ Dynamic Batch Types (database-driven instead of enum)
- ✅ Category-Batch Type assignments
- ✅ Batch Settings UI (`BatchSettings.jsx`)
